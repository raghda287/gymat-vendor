...
class HealthFoodServiceRepository {

  Future<ApiResponse> getCategories(int? limit) async {
    try {
      DioClient dioClient = DioClient();
      Response response = await dioClient
          .get(AppUrls.healthtFoodCategories, queryParameters: {'limit': limit});
  ...
  Future<ApiResponse> addCategories(String title) async {
    try {
      ...
      Response response =
          await dioClient.post(AppUrls.healthtFoodCategories, formData: data);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.handleError(e));
    }
  ...
  Future<ApiResponse> updateCategories(
    ...
    try {
      ...
      Response response = await dioClient.put(
          '${AppUrls.healthtFoodCategories}/$departmentId',
  ...
  Future<ApiResponse> deleteCategories(String departmentId) async {
    try {
      DioClient dioClient = DioClient();
      Response response =
          await dioClient.delete('${AppUrls.healthtFoodCategories}/$departmentId');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.handleError(e));
    }
  ...
  Future<ApiResponse> addService(
    ...
    try {
      ...
      FormData data = FormData.fromMap({
        ...
        'preparation_time': int.parse(duration),
      ...
      Response response =
          await dioClient.post(AppUrls.healthtFoodService, formData: data);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.handleError(e));
    }
  ...
  Future<ApiResponse> updateService(
    ...
    try {
      ...
      Response response = await dioClient
          .post('${AppUrls.healthtFoodService}/$serviceId', formData: data);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.handleError(e));
    }
  ...
  Future<ApiResponse> deleteService(String serviceId) async {
    try {
      DioClient dioClient = DioClient();
      Response response =
          await dioClient.delete('${AppUrls.healthtFoodService}/$serviceId');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.handleError(e));
    }
  ...
  Future<ApiResponse> getServicesByDepartment(int? page, num? category_id,
    ...
    try {
      ...
      DioClient dioClient = DioClient();
      Response response = await dioClient.get(AppUrls.healthtFoodService,
