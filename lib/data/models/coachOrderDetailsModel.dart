...
class CoachOrderDetailsModel {
  ...
  factory CoachOrderDetailsModel.fromJson(Map<String, dynamic> json) {
    return CoachOrderDetailsModel(
        json['id'],
        json['user_id'],
...
class Order {
  ...
  final num? service_option_id;
  final SubscribtionModel? service_option;
  final String? status;
  String? start_date;
  String? will_end_at;
  ...
  factory Order.fromJson(Map<String, dynamic> json) {
    return Order(
      ...
      json['service_option_id'],
      json['service_option'] != null
          ? SubscribtionModel.fromJson(json['service_option'])
          : null,
      json['status'],
      json['start_at'],
      json['will_end_at'],
