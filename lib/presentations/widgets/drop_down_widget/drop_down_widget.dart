...
class DropDownDepartmentWidget extends StatefulWidget {
  final List<DepartmentModel> departments;
  final ValueChanged<DepartmentModel> onValueSelected;
  final DepartmentModel? defaultValue;
  final bool isLoading;
  const DropDownDepartmentWidget({super.key, required this.departments, required this.onValueSelected, this.defaultValue, required this.isLoading});

  @override
  State<DropDownDepartmentWidget> createState() =>
      _DropDownDepartmentWidgetState();
}

class _DropDownDepartmentWidgetState extends State<DropDownDepartmentWidget> {
