...
class CoachAddService extends StatefulWidget {
  final ServiceModel? serviceModel;
  const CoachAddService({super.key, this.serviceModel});

  @override
  State<CoachAddService> createState() => _CoachAddServiceState();
}

class _CoachAddServiceState extends State<CoachAddService> {
  CoachServicesProvider gymServicesProvider =getIt();
              ...
              children: [
               Visibility(
                ...
                CustomButton(title: 'Confirm'.tr(), onTap: (){
                  ...
                  if(departmentModel!=null&&provider.servicePhotoPath!=null&&name.isNotEmpty&&regExp.hasMatch(price)&&description.isNotEmpty){
                    ...
                    if(widget.serviceModel==null){
                      provider.addService(departmentModel!.id!, name, price, description,discount,isDiscountActive,discountType);

                    }else{
                      provider.updateService(widget.serviceModel!.id!,departmentModel!.id!, name, price, description,discount,isDiscountActive,discountType);
