...
import '../coach_services_screen/coach_services_screen.dart';
import 'widgets/workout_widget.dart';

class CoachesWorkoutHomeScreen extends StatefulWidget {
  final LocalNotificationHandler? localNotificationHandler;

  const CoachesWorkoutHomeScreen({super.key, this.localNotificationHandler});

  @override
  State<CoachesWorkoutHomeScreen> createState() => _HealthClubSpaScreenState();
}

class _HealthClubSpaScreenState extends State<CoachesWorkoutHomeScreen> with WidgetsBindingObserver{
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async{
      ...
      coachHomeProvider.updateToken();
      coachHomeProvider.getDepartments();
      coachHomeProvider.getWorkouts();
      liveSessionProvider.getHomeLiveSession();
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                            ...
                            CardOrderWidget(
                              onTap: () {
                                ...
                                if(provider.getUserModel() != null &&!provider.getUserModel()!.providerModel!.is_accepted){
                                  ...
                                  NavigatorHandler.push(const CoachOrderScreen(
                                      orderType: 'up_coming'));
                                }
                  ...
                  trailing: InkWell(
                      ...
                      onTap: () {
                        ...
                        if(provider.getUserModel() != null &&!provider.getUserModel()!.providerModel!.is_accepted){
                          ...
                          NavigatorHandler.push(const CoachServicesScreen());
                ...
                Consumer<CoachHomeProvider>(builder: (context, provider, _) {
                  return Padding(
