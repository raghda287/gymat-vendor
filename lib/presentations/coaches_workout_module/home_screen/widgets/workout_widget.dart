...
import 'package:gymatvendor/presentations/coaches_workout_module/add_workout_screen/add_workout_screen.dart';
    ...
    return Column(
      ...
      children: [
        ListTile(
          ...
          leading: CustomSvgIcon(assetName: 'workout',width: 16,height: 16,color: AppTheme.isDarkMode()?Colors.white:mainColor,),
          title: CustomText(title: 'Add & share your Workout'.tr(),fontWeight: FontWeight.bold,fontColor: AppTheme.isDarkMode()?Colors.white:mainColor,fontSize: 14,),
          subtitle: CustomText(title: 'Add your workout and share it'.tr(),fontColor: greyColor,fontSize: 12,),
          trailing: InkWell(
