...
import 'coach_service_order_item.dart';

class CoachReciptDetails extends StatelessWidget {
  final CoachOrderDetailsModel model;

  const CoachReciptDetails({super.key,required this.model});
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                      flex: 3,
                      child: CustomText(textAlign: TextAlign.end,title: model.order?.start_date??'It will be determined from the coach'.tr(),fontSize: 13,fontColor: AppTheme.isDarkMode()?Colors.white:Colors.black,))
                ],
              ),
              const SizedBox(height: 16,),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                      flex: 3,
                      child: CustomText(textAlign: TextAlign.end,title: model.order?.will_end_at??'It will be determined from the coach'.tr(),fontSize: 13,fontColor: AppTheme.isDarkMode()?Colors.white:Colors.black,))
                ],
              ),
              ...
              const SizedBox(height: 12,),
              CoachServiceOrderItem(model: model),
              const SizedBox(height: 12,),
