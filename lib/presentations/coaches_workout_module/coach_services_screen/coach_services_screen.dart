...
import 'package:gymatvendor/presentations/coaches_workout_module/coach_add_service/coach_add_service.dart';
...
class CoachServicesScreen extends StatefulWidget {
  ...
  const CoachServicesScreen({super.key, this.homeDepartmentModel});
...
class _CoachServicesScreenState extends State<CoachServicesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      coachServicesProvider.init();
      coachServicesProvider.getDepartments(widget.homeDepartmentModel);
    });
  }
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ScrollablePositionedList.builder(
                        itemScrollController:
                            provider.serviceDepartmentItemController,
                                    ...
                                    if (model == null) {
                                      ...
                                      return ServiceItemWidget(
                                        ...
                                        onUpdate: (int index,ServiceModel model) async {
                                          ...
                                          NavigatorHandler.push(CoachAddService(serviceModel: model,));
                  ...
                  Center(
                    ...
                    onTap: () {
                      ProfileProvider profileProvider = getIt();
                      if(profileProvider.isAccountProviderCompleted()){
                        NavigatorHandler.push(const CoachAddService());
                ...
                CustomButton(
                    ...
                    onTap: () {
                      ...
                      if (name.isNotEmpty) {
                        NavigatorHandler.pop();
                        if (departmentModel == null) {
                          coachServicesProvider.addDepartment(name);
                        } else {
                          coachServicesProvider.updateDepartment(
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      ...
                      createDeleteAlertDialog(Text.rich(TextSpan(text: '${'Delete'.tr()} ',
                        ...
                        NavigatorHandler.pop();
                        coachServicesProvider.deleteDepartment(model);
                  ...
                  ListTile(
                    ...
                    onTap: () async {
                      ...
                      createDeleteAlertDialog(Text.rich(TextSpan(text: '${'Delete'.tr()} ',
                        ...
                        NavigatorHandler.pop();
                        await Future.delayed(const Duration(milliseconds: 300));
                        coachServicesProvider.deleteService(model);
