...
class ArrowIconCoach extends StatefulWidget {
  final GeneralOrderModel model;
  final int index ;
  const ArrowIconCoach({super.key, required this.model, required this.index});

  @override
  State<ArrowIconCoach> createState() => _ArrowIconCoachState();
}

class _ArrowIconCoachState extends State<ArrowIconCoach> with TickerProviderStateMixin{
