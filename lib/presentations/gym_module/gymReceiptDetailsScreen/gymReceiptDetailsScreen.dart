...
class GymReceiptDetailsScreen extends StatefulWidget {
  final GymOrderDetailsModel model;
  const GymReceiptDetailsScreen({super.key, required this.model});

  @override
  State<GymReceiptDetailsScreen> createState() => _GymReceiptDetailsScreenState();
}

class _GymReceiptDetailsScreenState extends State<GymReceiptDetailsScreen> {
          ...
          children: [
            Expanded(
              child: Stack(children: [
                ReciptDetailsPrint(model: widget.model,screenshotController: screenshotController,),
                ReciptDetails(model: widget.model)
              ],),
            ),
