...
class GymServicesScreen extends StatefulWidget {
  ...
  const GymServicesScreen({super.key, this.homeDepartmentModel});
...
class _GymServicesScreenState extends State<GymServicesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      gymServicesProvider.init();
      gymServicesProvider.getDepartments(widget.homeDepartmentModel);
    });
  }
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ScrollablePositionedList.builder(
                        itemScrollController:
                            provider.gymServiceDepartmentItemController,
                            ...
                            onLongTap: () {
                              if (model.id == 1) {
                                CustomScaffoldMessanger.showScaffoledMessanger(
                                    title: 'This department cannot be modified'.tr());
                              } else {
                      ...
                      child: provider.isLoading
                          ...
                          : provider.services.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  itemBuilder: (context, index) {
                                    ServiceModel? model = provider.services[index];
                                    if (model == null) {
                                      ...
                                      return ServiceItemWidget(
                                        serviceModel: model,
                                        index: index,
                                        onUpdate: (int index,ServiceModel model) async {
                                          await Future.delayed(const Duration(milliseconds: 300));
                                          if(model.category!=null&&model.category!.id !=1){
                                            NavigatorHandler.push(GymAddService(serviceModel: model,));
                                          }else{
                                            NavigatorHandler.push(GymAddMemberShipService(serviceModel: model,));
                                          }
                                        ...
                                        onDelete: (index) async{
                                          ...
                                          createDeleteAlertDialog(Text.rich(TextSpan(text: '${'Delete'.tr()} ',
                                            ...
                                            GymServicesProvider provider = getIt();
                                            provider.deleteService(model);
                  ...
                  Center(
                    ...
                    onTap: () {
                      ProfileProvider profileProvider = getIt();
                      if(profileProvider.isAccountProviderCompleted()){
                        NavigatorHandler.push(const GymAddService());
                ...
                CustomButton(
                    ...
                    onTap: () {
                      ...
                      if (name.isNotEmpty) {
                        NavigatorHandler.pop();
                        if (departmentModel == null) {
                          gymServicesProvider.addDepartment(name);
                        } else {
                          gymServicesProvider.updateDepartment(
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      ...
                      createDeleteAlertDialog(Text.rich(TextSpan(text: '${'Delete'.tr()} ',
                        style: AppTextStyles().normalText(fontSize: 13).textColorNormal(AppTheme.isDarkMode()?greyColor:Colors.black),
                        children: [
                          TextSpan(text: model.getTitle()??'',style: AppTextStyles().normalText(fontSize: 17).textColorBold(AppTheme.isDarkMode()?greyColor:Colors.black))
                        ]
                      )),(){
                        NavigatorHandler.pop();
                        gymServicesProvider.deleteDepartment(model);
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () async {
                      ...
                      createDeleteAlertDialog(Text.rich(TextSpan(text: '${'Delete'.tr()} ',
                        ...
                        await Future.delayed(const Duration(milliseconds: 300));
                        if(model.category!=null&&model.category!.id !=1){
                          gymServicesProvider.deleteService(model);

                        }else if(model.category!=null&&model.category!.id ==1){
                          gymServicesProvider.deleteMembershipService(model);
                  ...
                  ListTile(
                    ...
                    onTap: () async{
                      ...
                      if(model.category!=null&&model.category!.id !=1){
                        NavigatorHandler.push(GymAddService(
                          serviceModel: model,
                        ));
                      }else{
                        NavigatorHandler.push(GymAddMemberShipService(
                          serviceModel: model,
                        ));
                      }
