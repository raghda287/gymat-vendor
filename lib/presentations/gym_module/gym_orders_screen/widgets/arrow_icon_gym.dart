...
class ArrowIconGym extends StatefulWidget {
  final GeneralOrderModel model;
  final int index ;
  const ArrowIconGym({super.key, required this.model, required this.index});

  @override
  State<ArrowIconGym> createState() => _ArrowIconGymState();
}

class _ArrowIconGymState extends State<ArrowIconGym> with TickerProviderStateMixin{
