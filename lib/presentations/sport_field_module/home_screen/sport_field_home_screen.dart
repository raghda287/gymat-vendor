...
import 'package:gymatvendor/presentations/sport_field_module/sports_field_orders_screen/sportsFieldOrderScreen.dart';
import 'package:gymatvendor/presentations/sport_field_module/sports_field_services_screen/sports_field_services_screen.dart';
...
class SportFieldHomeScreen extends StatefulWidget {
  final LocalNotificationHandler? localNotificationHandler;

  const SportFieldHomeScreen({super.key, this.localNotificationHandler});

  @override
  State<SportFieldHomeScreen> createState() => _HealthClubSpaScreenState();
}

class _HealthClubSpaScreenState extends State<SportFieldHomeScreen> with WidgetsBindingObserver{
  SportsFieldHomeProvider sportsFieldHomeProvider = getIt();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async{
      ...
      sportsFieldHomeProvider.getStatistics();
      sportsFieldHomeProvider.updateToken();
      sportsFieldHomeProvider.getDepartments();
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Consumer<SportsFieldHomeProvider>(
                            ...
                            CardOrderWidget(
                              onTap: () {
                                ...
                                if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                                  ...
                                  NavigatorHandler.push(const SportsFieldOrderScreen(orderType: 'up_coming'));
                            ...
                            provider.isLoadingStatistics||provider.statisticsHomeModel==null?const CardOrderPlaceholderWidget() :CardOrderWidget(
                              onTap: () {
                                ...
                                if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                                  ...
                                  NavigatorHandler.push(const SportsFieldOrderScreen(orderType: 'complete'));
                  ...
                  trailing: InkWell(
                      ...
                      onTap: () {
                        ...
                        if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                          ...
                          NavigatorHandler.push(const SportsFieldServicesScreen());
                ...
                Consumer<SportsFieldHomeProvider>(builder: (context, provider, _) {
                  return Padding(
                          ...
                          return HomeCategoryWidget(
                              ...
                              onTap: () {
                                ...
                                if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                                  ...
                                  NavigatorHandler.push(SportsFieldServicesScreen(homeDepartmentModel: provider.departments[index],));
