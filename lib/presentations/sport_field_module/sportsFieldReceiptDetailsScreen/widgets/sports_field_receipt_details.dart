...
import 'package:gymatvendor/presentations/sport_field_module/sportsFieldReceiptDetailsScreen/widgets/sports_field_service_order_item.dart';
...
class SportsFieldReciptDetails extends StatelessWidget {
  final SportsFieldOrderDetailsModel model;

  const SportsFieldReciptDetails({super.key,required this.model});
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                      flex: 4,
                      child: CustomText(textAlign: TextAlign.end,title: '${model.order?.date??''} ${model.order?.time??''}',fontSize: 14,fontColor: AppTheme.isDarkMode()?Colors.white:Colors.black,))
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                      flex: 2,
                      child: CustomText(title: 'Booking end time'.tr(),fontSize: 14,fontColor: AppTheme.isDarkMode()?Colors.white:Colors.black,)),
                  Expanded(
                      flex: 3,
                      child: CustomText(textAlign: TextAlign.end,title: model.order?.service_end_at??'',fontSize: 14,fontColor: AppTheme.isDarkMode()?Colors.white:Colors.black,))
                ],
              ),
              ...
              const SizedBox(height: 12,),
              SportsFieldServiceOrderItem(model: model),
              const SizedBox(height: 12,),
