...
class SportsFieldServiceOrderItemPrint extends StatelessWidget {
  final SportsFieldOrderDetailsModel model ;
  const SportsFieldServiceOrderItemPrint({super.key, required this.model});
          ...
          children: [
            ...
            Expanded(child: Padding(
              ...
              child: Column(
                ...
                children: [
                  CustomText(title: '${model.order?.service?.getTitle()}',fontColor: Colors.black,fontSize: 14,maxLines: 1,),
                  const SizedBox(height: 8,),
                  Row(
                    children: [
                      CustomText(title: 'Price:'.tr(),fontColor: greyColor,fontSize: 12,maxLines: 1,),
                      const SizedBox(width: 4,),
                      CustomText(title: CustomNumberFormat.format(model.grand_total??0),fontColor:Colors.black,fontSize: 13,maxLines: 1,fontWeight: FontWeight.bold,),
                      const SizedBox(width: 4,),
