...
class SportsFieldServiceOrderItem extends StatelessWidget {
  final SportsFieldOrderDetailsModel model ;
  const SportsFieldServiceOrderItem({super.key, required this.model});
          ...
          children: [
            ...
            Expanded(child: Padding(
              ...
              child: Column(
                ...
                children: [
                  CustomText(title:'${model.order?.service?.getTitle()}',fontColor: mainColor,fontSize: 14,maxLines: 1,),
