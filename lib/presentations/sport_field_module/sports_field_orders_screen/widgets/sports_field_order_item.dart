...
import 'package:gymatvendor/presentations/sport_field_module/sports_field_orders_screen/widgets/arrow_icon_sports_field.dart';
import 'package:gymatvendor/presentations/sport_field_module/sports_field_orders_screen/widgets/text_animation_widget.dart';
...
class SportsFieldOrderItem extends StatelessWidget {
  final GeneralOrderModel model;
  final int index;

  const SportsFieldOrderItem({super.key, required this.model, required this.index});
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                            ...
                            child: CustomText(title: 'Tax:'.tr(),fontSize: 14,fontColor: AppTheme.isDarkMode()?Colors.white:Colors.black,)),
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                            ...
                            child: CustomText(title: 'Discount:'.tr(),fontSize: 14,fontColor: AppTheme.isDarkMode()?Colors.white:Colors.black,)),
