...
class ArrowIconSportsField extends StatefulWidget {
  final GeneralOrderModel model;
  final int index ;
  const ArrowIconSportsField({super.key, required this.model, required this.index});

  @override
  State<ArrowIconSportsField> createState() => _ArrowIconSportsFieldState();
}

class _ArrowIconSportsFieldState extends State<ArrowIconSportsField> with TickerProviderStateMixin{
