...
class FoodServiceOrderItem extends StatelessWidget {
  final OrderFoodDetails model ;
  const FoodServiceOrderItem({super.key, required this.model});
            ...
            children: [
              ...
              Expanded(child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomText(title: model.serviceModel?.getTitle(),fontColor: mainColor,fontSize: 14,maxLines: 1,),
