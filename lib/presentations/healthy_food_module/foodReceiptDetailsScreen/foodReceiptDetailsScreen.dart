...
class FoodReceiptDetailsScreen extends StatefulWidget {
  final FoodOrderDetailsModel model;
  const FoodReceiptDetailsScreen({super.key, required this.model});

  @override
  State<FoodReceiptDetailsScreen> createState() => _FoodReceiptDetailsScreenState();
}

class _FoodReceiptDetailsScreenState extends State<FoodReceiptDetailsScreen> {
          ...
          children: [
            Expanded(
              child: Stack(children: [
                FoodReciptDetailsPrint(model: widget.model,screenshotController: screenshotController,),
                FoodReciptDetails(model: widget.model)
              ],),
            ),
