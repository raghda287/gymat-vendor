...
import 'package:gymatvendor/presentations/healthy_food_module/food_orders_screen/widgets/arrow_icon_food.dart';
...
class FoodOrderItem extends StatelessWidget {
  ...
  const FoodOrderItem({super.key, required this.model, required this.index});
