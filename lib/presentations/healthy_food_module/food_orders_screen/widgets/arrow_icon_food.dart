...
class ArrowIconFood extends StatefulWidget {
  final GeneralOrderModel model;
  final int index ;
  const ArrowIconFood({super.key, required this.model, required this.index});

  @override
  State<ArrowIconFood> createState() => _ArrowIconFoodState();
}

class _ArrowIconFoodState extends State<ArrowIconFood> with TickerProviderStateMixin{
