...
class HealthyFoodServiceItemWidget extends StatelessWidget {
  ...
  const HealthyFoodServiceItemWidget(
      {super.key,
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    children: [
                      ...
                      CustomText(
                        title:'${serviceModel.calories??''} ${'Cal'.tr()}',
                        fontSize: 12,
                        fontColor: mainColor,
                        maxLines: 1,
                      ...
                      Row(
                        children: [
                          CustomText(
                            title:
                            '${formatNumber(serviceModel.has_offer!=null&&serviceModel.has_offer!?serviceModel.new_price??0.00:serviceModel.price ?? 0.00)}',
                            fontSize: 14,
