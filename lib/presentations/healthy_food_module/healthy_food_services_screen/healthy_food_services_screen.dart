...
import '../healthy_food_add_service/healthy_food_add_service_screen.dart';
import '../provider/healthy_food_services_provider.dart';
import 'widgets/healthy_food_service_item_widget.dart';

class HealthyFoodServicesScreen extends StatefulWidget {
  final DepartmentModel? homeDepartmentModel;

  const HealthyFoodServicesScreen({super.key, this.homeDepartmentModel});

  @override
  State<HealthyFoodServicesScreen> createState() => _HealthyFoodServicesScreenState();
}

class _HealthyFoodServicesScreenState extends State<HealthyFoodServicesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      healthyFoodServicesProvider.init();
      healthyFoodServicesProvider.getDepartments(widget.homeDepartmentModel);
    });
  }
                ...
                children: [
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    if (model == null) {
                                      ...
                                      return HealthyFoodServiceItemWidget(
                                        serviceModel: model,
                                        index: index,
                                        onUpdate: (int index,
                                          ...
                                          await Future.delayed(const Duration(
                                              milliseconds: 300));
                                          NavigatorHandler.push(HealthyFoodAddServiceScreen(
                                            serviceModel: model,
                                          ));
                                        },
                                        onDelete: (index) async {
                                          ...
                                          createDeleteAlertDialog(
                                            ...
                                            healthyFoodServicesProvider.deleteService(model);
                                          }, () {
                                            NavigatorHandler.pop();
                                          });
                                        },
                  ...
                  Center(
                    ...
                    onTap: () {
                      ProfileProvider profileProvider = getIt();
                      if (profileProvider.isAccountProviderCompleted()) {
                        NavigatorHandler.push(const HealthyFoodAddServiceScreen());
                      } else {
                        CustomScaffoldMessanger.showScaffoledMessanger(
                            title:
                            'Complete your information to verify the account'
                ...
                CustomButton(
                    ...
                    onTap: () {
                      ...
                      if (name.isNotEmpty) {
                        NavigatorHandler.pop();
                        if (departmentModel == null) {
                          healthyFoodServicesProvider.addDepartment(name);
                        } else {
                          healthyFoodServicesProvider.updateDepartment(
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      ...
                      createDeleteAlertDialog(
                        ...
                        NavigatorHandler.pop();
                        healthyFoodServicesProvider.deleteDepartment(model);
                      }, () {
                        NavigatorHandler.pop();
                      });
                    },
