...
class MessageRight extends StatelessWidget {
  ...
  const MessageRight({super.key, required this.model});
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
        ...
        child: Row(
          children: [
            Card(
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.only(topLeft: Radius.circular(textWidth>200?8:36),topRight: Radius.circular(textWidth>200?16:24),bottomLeft: Radius.circular(textWidth>200?8:36),bottomRight: Radius.circular(8))),
              ...
              */
                      ...
                      child: Column(
                        ...
                        children: [
                          if(model.message!=null&&model.message!.contains('https://gymatapp.com/api/coach/joinCall/'))
                            ...
                            Container(
                              color: AppTheme.isDarkMode()?msgRightMeetDarkColor.withOpacity(0.5):greyColor.withOpacity(0.06),
                              child: Row(
                                children: [
                                  Container(
                                    width: 48,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      CustomText(title: 'Join meet'.tr(),fontSize: 11,fontColor: AppTheme.isDarkMode()?Colors.white.withOpacity(.8):Colors.black.withOpacity(.8),)
                                    ],
                                  )
                                ],
                              ),
                    ...
                    CustomText(
                        title: CustomDateTimeFormat().getNowDate() == model.date
                            ? model.time ?? ''
          ...
          TextSpan(
            ...
            recognizer: TapGestureRecognizer()
              ..onTap = () async{
                ...
                if(status){
                  NavigatorHandler.push(WebViewVideoCallScreen(link: url,));
                }else{
