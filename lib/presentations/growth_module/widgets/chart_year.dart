...
class ChartYearWidget extends StatelessWidget {
  final List<ChartModel> dataSeries;
  const ChartYearWidget({super.key, required this.dataSeries});
  @override
  Widget build(BuildContext context) {
    ...
    return SfCartesianChart(
      ...
      primaryXAxis: CategoryAxis(
        ...
        majorTickLines: const MajorTickLines(size: 8,color: Colors.transparent),
