...
import 'package:gymatvendor/presentations/healthcub_spa_module/spaReceiptDetailsScreen/widgets/receipt_details.dart';
import 'package:gymatvendor/presentations/healthcub_spa_module/spaReceiptDetailsScreen/widgets/receipt_details_print.dart';
import 'package:gymatvendor/presentations/healthy_food_module/foodReceiptDetailsScreen/widgets/food_receipt_details.dart';
import 'package:gymatvendor/presentations/healthy_food_module/foodReceiptDetailsScreen/widgets/food_receipt_details_print.dart';
import 'package:gymatvendor/presentations/shop_module/shop_receipt_details_screen/widgets/shop_receipt_details.dart';
import 'package:gymatvendor/presentations/shop_module/shop_receipt_details_screen/widgets/shop_receipt_details_print.dart';
...
class ShopReceiptDetailsScreen extends StatefulWidget {
  final ShopOrderDetailsModel model;
  const ShopReceiptDetailsScreen({super.key, required this.model});

  @override
  State<ShopReceiptDetailsScreen> createState() => _ShopReceiptDetailsScreenState();
}

class _ShopReceiptDetailsScreenState extends State<ShopReceiptDetailsScreen> {
          ...
          children: [
            Expanded(
              child: Stack(children: [
                ShopReciptDetailsPrint(model: widget.model,screenshotController: screenshotController,),
                ShopReciptDetails(model: widget.model)
              ],),
            ),
