...
class ShopServiceOrderItemPrint extends StatelessWidget {
  final OrderShopDetails model ;
  const ShopServiceOrderItemPrint({super.key, required this.model});
            ...
            children: [
              ...
              Expanded(child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomText(title: model.product?.getTitle(),fontColor: Colors.black,fontSize: 14,maxLines: 1,),
                    ...
                    if(model.product_price?.title!=null&&model.product_price!.title!.isNotEmpty)Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        CustomText(title: model.product_price?.title??'',fontColor: Colors.black,fontSize: 14,maxLines: 1,),
                        const SizedBox(height: 4,),
