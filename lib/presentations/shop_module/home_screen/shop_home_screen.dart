...
import '../shop_orders_screen/shopOrderScreen.dart';
import '../shop_services_screen/shop_services_screen.dart';

class ShopHomeScreen extends StatefulWidget {
  final LocalNotificationHandler? localNotificationHandler;

  const ShopHomeScreen({super.key, this.localNotificationHandler});

  @override
  State<ShopHomeScreen> createState() => _HealthClubSpaScreenState();
}

class _HealthClubSpaScreenState extends State<ShopHomeScreen>  with WidgetsBindingObserver{
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                            ...
                            CardOrderWidget(
                              onTap: () {
                                ...
                                if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                                  ...
                                  NavigatorHandler.push(const ShopOrderScreen(orderType: 'up_coming'));
                            ...
                            provider.isLoadingStatistics||provider.statisticsHomeModel==null?const CardOrderPlaceholderWidget() :CardOrderWidget(
                              onTap: () {
                                ...
                                if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                                  ...
                                  NavigatorHandler.push(const ShopOrderScreen(orderType: 'complete'));
                  ...
                  trailing: InkWell(
                      ...
                      onTap: (){
                        ProfileProvider providerProfile = getIt();
                          ...
                          if (providerProfile.getUserModel() != null &&
                              !providerProfile
                                  .getUserModel()!
                                  .providerModel!
                                  .is_accepted) {
                            CustomScaffoldMessanger.showToast(
                                title:
                                    'Please wait, your information is being reviewed.'
                                        .tr());
                          } else {
                  ...
                  trailing: InkWell(
                      ...
                      onTap: () {
                        ...
                        if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                          ...
                          NavigatorHandler.push(const ShopServicesScreen());
                ...
                Consumer<ShopHomeProvider>(builder: (context, provider, _) {
                  return Padding(
                          ...
                          return HomeCategoryWidget(
                              ...
                              onTap: () {
                                ...
                                if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                                  ...
                                  NavigatorHandler.push(ShopServicesScreen(departmentModel: provider.departments[index],));
