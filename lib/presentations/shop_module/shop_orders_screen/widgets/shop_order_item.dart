...
import 'package:gymatvendor/presentations/shop_module/shop_orders_screen/widgets/arrow_icon_shop.dart';
...
class ShopOrderItem extends StatelessWidget {
  ...
  const ShopOrderItem({super.key, required this.model, required this.index});
