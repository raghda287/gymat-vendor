...
class SpaReceiptDetailsScreen extends StatefulWidget {
  final SpaOrderDetailsModel model;
  const SpaReceiptDetailsScreen({super.key, required this.model});

  @override
  State<SpaReceiptDetailsScreen> createState() => _SpaReceiptDetailsScreenState();
}

class _SpaReceiptDetailsScreenState extends State<SpaReceiptDetailsScreen> {
          ...
          children: [
            Expanded(
              child: Stack(children: [
                SpaReciptDetailsPrint(model: widget.model,screenshotController: screenshotController,),
                SpaReciptDetails(model: widget.model)
              ],),
            ),
