...
import '../spa_orders_screen/spaOrderScreen.dart';
import '../spa_services_screen/spa_services_screen.dart';

class HealthClubSpaHomeScreen extends StatefulWidget {
  final LocalNotificationHandler? localNotificationHandler;

  const HealthClubSpaHomeScreen({super.key, this.localNotificationHandler});

  @override
  State<HealthClubSpaHomeScreen> createState() => _HealthClubSpaScreenState();
}

class _HealthClubSpaScreenState extends State<HealthClubSpaHomeScreen> with WidgetsBindingObserver{
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async{
      ...
      healthyClubSpaHomeProvider.getStatistics();
      healthyClubSpaHomeProvider.updateToken();
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Consumer<HealthyClubSpaHomeProvider>(
                            ...
                            CardOrderWidget(
                              onTap: () {
                                ...
                                if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                                  ...
                                  NavigatorHandler.push(const SpaOrderScreen(orderType: 'up_coming'));
                            ...
                            provider.isLoadingStatistics||provider.statisticsHomeModel==null?const CardOrderPlaceholderWidget() :CardOrderWidget(
                              onTap: () {
                                ...
                                if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                                  ...
                                  NavigatorHandler.push(const SpaOrderScreen(orderType: 'complete'));
                  ...
                  trailing: InkWell(
                      ...
                      onTap: () {
                        ...
                        if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                          ...
                          NavigatorHandler.push(const SpaServicesScreen());
                ...
                Consumer<HealthyClubSpaHomeProvider>(builder: (context, provider, _) {
                  return Padding(
                          ...
                          return HomeCategoryWidget(
                              ...
                              onTap: () {
                                ...
                                if(providerProfile.getUserModel() != null &&!providerProfile.getUserModel()!.providerModel!.is_accepted){
                                  ...
                                  NavigatorHandler.push(SpaServicesScreen(homeDepartmentModel: provider.departments[index],));
