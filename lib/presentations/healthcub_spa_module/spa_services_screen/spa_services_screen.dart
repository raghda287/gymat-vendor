...
import '../provider/spa_services_provider.dart';
import '../spa_add_service/spa_add_service.dart';

class SpaServicesScreen extends StatefulWidget {
  final DepartmentModel? homeDepartmentModel;

  const SpaServicesScreen({super.key, this.homeDepartmentModel});
...
class _SpaServicesScreenState extends State<SpaServicesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      spaServicesProvider.init();
      spaServicesProvider.getDepartments(widget.homeDepartmentModel);
    });
  }
                ...
                children: [
                                      ...
                                      return ServiceItemWidget(
                                        ...
                                        onUpdate: (int index,
                                          ...
                                          await Future.delayed(const Duration(
                                              milliseconds: 300));
                                          NavigatorHandler.push(SpaAddService(
                                            serviceModel: model,
                                          ));
                                        },
                  ...
                  Center(
                    ...
                    onTap: () {
                      ProfileProvider profileProvider = getIt();
                      if (profileProvider.isAccountProviderCompleted()) {
                        NavigatorHandler.push(const SpaAddService());
                      } else {
                        CustomScaffoldMessanger.showScaffoledMessanger(
                            title:
                                'Complete your information to verify the account'
                ...
                CustomButton(
                    ...
                    onTap: () {
                      ...
                      if (name.isNotEmpty) {
                        NavigatorHandler.pop();
                        if (departmentModel == null) {
                          spaServicesProvider.addDepartment(name);
                        } else {
                          spaServicesProvider.updateDepartment(
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      ...
                      createDeleteAlertDialog(
                        ...
                        NavigatorHandler.pop();
                        spaServicesProvider.deleteDepartment(model);
                      }, () {
                        NavigatorHandler.pop();
                      });
                    },
                  ...
                  ListTile(
                    ...
                    onTap: () async {
                      ...
                      createDeleteAlertDialog(
                        ...
                        NavigatorHandler.pop();
                        await Future.delayed(const Duration(milliseconds: 300));
                        spaServicesProvider.deleteService(model);
                      }, () {
                        NavigatorHandler.pop();
                      });
                    },
