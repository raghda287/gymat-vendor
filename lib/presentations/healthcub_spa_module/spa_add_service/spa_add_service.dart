...
class SpaAddService extends StatefulWidget {
  final ServiceModel? serviceModel;
  const SpaAddService({super.key, this.serviceModel});

  @override
  State<SpaAddService> createState() => _SpaAddServiceState();
}

class _SpaAddServiceState extends State<SpaAddService> {
  SpaServicesProvider spaServicesProvider =getIt();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      spaServicesProvider.initAddService();
    if(widget.serviceModel!=null){
      spaServicesProvider.servicePhotoPath = widget.serviceModel!.photo;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<SpaServicesProvider>(
                ...
                children: [
                  InkWell(
                    onTap: () async{
                      ...
                      NavigatorHandler.pop();
                      spaServicesProvider.pickImage(ImageSource.camera,);
                    },
                    child: Column(
                      children: [
                        CustomSvgIcon(
                  ...
                  InkWell(
                    onTap: () {
                      NavigatorHandler.pop();
                      spaServicesProvider.pickImage(ImageSource.gallery);
                    },
                    child: Column(
                      children: [
                        CustomSvgIcon(
