...
class ArrowIconSpa extends StatefulWidget {
  final GeneralOrderModel model;
  final int index ;
  const ArrowIconSpa({super.key, required this.model, required this.index});

  @override
  State<ArrowIconSpa> createState() => _ArrowIconSpaState();
}

class _ArrowIconSpaState extends State<ArrowIconSpa> with TickerProviderStateMixin{
