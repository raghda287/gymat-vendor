...
import 'package:gymatvendor/presentations/healthcub_spa_module/spa_orders_screen/widgets/arrow_icon_spa.dart';
...
class SpaOrderItem extends StatelessWidget {
  final GeneralOrderModel model;
  final int index;

  const SpaOrderItem({super.key, required this.model, required this.index});
